class MoviesController < ApplicationController
  ...
  def search
    ...
    @errors_msg = false
    @errors_msg = "No movie match found!" if response["Response"] == "False"
  ...
  def build_movie_attrs response
    ...
    response.reduce(movie_attrs){ |hash,(k,v)| hash[k.downcase.to_sym] = v if movie_keys_to_include.include? k.downcase.to_sym; hash; }
